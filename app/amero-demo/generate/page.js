...
export default function GenerateAmero() {
    ...
    const generateAI = () => {
        ...
        if(character == 'morraine' && styleGender =='woman'){
            setTimeout(() => {
                generateImageSwap(character, styleGender, getRandomInt(0, 18))
            }, 500);
            ...
            {numProses1 && 
                <div className='absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center flex-col'>
                    ...
                    <div className='relative w-[250px] h-[250px] lg:w-[450px] lg:h-[450px] overflow-hidden'>
                        ...
                        <div className={`animate-morraineloading absolute left-0 top-0  w-[2000px] lg:w-[3645px] mx-auto flex justify-center items-center pointer-events-none ${character == 'morraine' ? '' : 'opacity-0'}`}>
                        ...
                        <div>
                            ...
                            <ul className='choose2-amero'>
                                <li>
                                    ...
                                    />
                                    <label htmlFor="choose_gender1" className='text-base lg:h-[140px] lg:text-4xl'>Female</label>
                                </li>
                                <li>
                                    <input
                                    id='choose_gender2'
                                    ...
                                    onChange={(e) => setStyleGender(e.target.value)}
                                    />
                                    <label htmlFor="choose_gender2" className='text-base lg:h-[140px] lg:text-4xl'>Female with Hijab</label>
                                </li>
                            </ul>
                        </div>
                    </div>
