...
export default function Register() {
    ...
    const generateImageSwap = async () => {
        ...
        .then(dataUrl => {
            ...
            setTimeout(() => {
                router.push('/mobilelegend/result');
            }, 500);
        })
        } catch (error) {
            setError(error);
                    ...
                    <div className='relative w-full mt-8 lg:mt-10'>
                        ...
                        <div className='overflow-auto'>
                            ...
                            <li>
                                ...
                                type="radio"
                                name='choose_style'
                                value="https://ai.zirolu.id/mobilelegend/ml-1.jpeg"
                                onChange={(e) => setCharacter(e.target.value)}
                                />
                                <label htmlFor="choose_style1">
                                <Image
                                    className="relative h-auto w-full"
                                    src="/mobilelegend/ml-1.jpeg"
                                    alt="icon"
                                    width={384}
                                    height={660}
                                    priority
                            ...
                            <li>
                                ...
                                type="radio"
                                name='choose_style'
                                value="https://ai.zirolu.id/mobilelegend/ml-2.jpeg"
                                onChange={(e) => setCharacter(e.target.value)}
                                />
                                <label htmlFor="choose_style3">
                                <Image
                                    className="relative h-auto w-full"
                                    src="/mobilelegend/ml-2.jpeg"
                                    alt="icon"
                                    width={384}
                                    height={660}
                                    priority
                            ...
                            <li>
                                ...
                                type="radio"
                                name='choose_style'
                                value="https://ai.zirolu.id/mobilelegend/ml-3.jpeg"
                                onChange={(e) => setCharacter(e.target.value)}
                                />
                                <label htmlFor="choose_style2">
                                <Image
                                    className="relative h-auto w-full"
                                    src="/mobilelegend/ml-3.jpeg"
                                    alt="icon"
                                    width={384}
                                    height={660}
                                    priority
                            ...
                            <li>
                                ...
                                type="radio"
                                name='choose_style'
                                value="https://ai.zirolu.id/mobilelegend/ml-4.jpeg"
                                onChange={(e) => setCharacter(e.target.value)}
                                />
                                <label htmlFor="choose_style4">
                                <Image
                                    className="relative h-auto w-full"
                                    src="/mobilelegend/ml-4.jpeg"
                                    alt="icon"
                                    width={384}
                                    height={660}
                                    priority
                            ...
                            <li>
                                ...
                                type="radio"
                                name='choose_style'
                                value="https://ai.zirolu.id/mobilelegend/ml-5.jpeg"
                                onChange={(e) => setCharacter(e.target.value)}
                                />
                                <label htmlFor="choose_style5">
                                <Image
                                    className="relative h-auto w-full"
                                    src="/mobilelegend/ml-5.jpeg"
                                    alt="icon"
                                    width={384}
                                    height={660}
                                    priority
                            ...
                            <li>
                                ...
                                type="radio"
                                name='choose_style'
                                value="https://ai.zirolu.id/mobilelegend/ml-6.jpeg"
                                onChange={(e) => setCharacter(e.target.value)}
                                />
                                <label htmlFor="choose_style6">
                                <Image
                                    className="relative h-auto w-full"
                                    src="/mobilelegend/ml-6.jpeg"
                                    alt="icon"
                                    width={384}
                                    height={660}
                                    priority
