...
export default function GenerateAmero() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-kai overflow-auto flex-col items-center justify-top pt-7 pb-5 px-5 lg:pt-12 lg:px-20">
            <TopLogoKAI></TopLogoKAI>
            <h1 className={`text-center text-xl font-bold mt-1 lg:mt-0 lg:text-5xl mb-2 lg:mb-5 ${poppins.className} ${numProses1 ? 'opacity-0 pointer-events-none' : ''}`}>CHOOSE GENDER</h1>
            {/* LOADING */}
            {numProses1 && 
