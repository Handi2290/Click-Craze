...
export default function Register() {
    ...
    const generateImageSwap = async () => {
        const urlGambar = 'https://ai.zirolu.id/uniqlo/'+prompt1+'-1.jpeg';
    ...
    const generateImageSwap2 = async () => {
        const urlGambar = 'https://ai.zirolu.id/uniqlo/'+prompt1+'-2.jpeg';
        console.log(urlGambar)
    ...
    const generateImageSwap3 = async () => {
        const urlGambar = 'https://ai.zirolu.id/uniqlo/'+prompt1+'-3.jpeg';
        console.log(urlGambar)
